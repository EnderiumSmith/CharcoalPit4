    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(BlockRegistry.CHARCOAL_BLOCK.get(),BlockRegistry.COKE_BLOCK.get(),BlockRegistry.ACTIVE_COAL_PILE.get(),BlockRegistry.BLOOMERY_BRICK.get(),BlockRegistry.BLOOMERY_SANDY.get(),BlockRegistry.BLOOMERY_NETHER.get(),
                        ...
                        BlockRegistry.MARBLE_WALL.get(),BlockRegistry.MARBLE_PILLAR.get(),BlockRegistry.CREOSOTE_FUNNEL_BRICK.get(),BlockRegistry.CREOSOTE_FUNNEL_SANDY.get(),BlockRegistry.CREOSOTE_FUNNEL_NETHER.get(),
                        ...
                        BlockRegistry.MAGENTA_POT.get(),BlockRegistry.PINK_POT.get());
        ...
        tag(BlockTags.INCORRECT_FOR_STONE_TOOL)
                .add(BlockRegistry.BRONZE_BLOCK.get(),BlockRegistry.STEEL_BLOCK.get());
        tag(BlockTags.INCORRECT_FOR_WOODEN_TOOL)
                .add(BlockRegistry.ORE_TIN.get(),BlockRegistry.TIN_BLOCK.get());
        tag(ModTags.REFRACTORY_BLOCKS)
                .add(Blocks.BRICKS,Blocks.BRICK_SLAB,Blocks.BRICK_STAIRS,
                        ...
                        BlockRegistry.CREOSOTE_FUNNEL_BRICK.get(),BlockRegistry.CREOSOTE_FUNNEL_SANDY.get(),BlockRegistry.CREOSOTE_FUNNEL_NETHER.get(),
        ...
        tag(BlockTags.BEACON_BASE_BLOCKS).add(BlockRegistry.BRONZE_BLOCK.get(),BlockRegistry.STEEL_BLOCK.get());
    }
}
